...
//       if (!response.ok) {
//         throw new Error(
//           "No se encontro el pokemon,verifica el nombre e intentalo de nuevo"
//         );
//       }
...
//       const evolutionChainData = await fetch(speciesInfo.evolution_chain.url);
//       if (!evolutionChainData.ok) {
//         throw new Error(
//           "Error al obtener la información de evolucion del pokemon"
//         );
//       }
//       const chainData = await evolutionChainData.json();
//       showPokemonInfo(data, speciesInfo, chainData);
//     } catch (error) {
//       console.error("Error al cargar los detalles del pokemon", error);
//     }
//   });
...
//   function showPokemonInfo(data, speciesInfo, evolutionChainData) {
//     
//     pokemonInfo.classList.remove("hidden");
...
//     evolveButton.addEventListener("click", async () => {
//       try{
//         const evolutionPokemon = evolutionChainData.chain.evolves_to[0].species.name;
//         const evolutionData = await fetch(`https://pokeapi.co/api/v2/pokemon/${evolutionPokemon}`);
//         if(!evolutionData.ok){
//           throw new Error("Error al obtener la información de evolucion del pokemon");
//         }
//         const evolutionPokemon = await evolutionData.json();
//         showPokemonInfo(evolutionPokemon, speciesInfo, evolutionChainData);
//       }catch(error){
//         console.error("Error al cargar los detalles del pokemon", error);
//       }
//     });
